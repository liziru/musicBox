...
CFLAGS = #-O2
DBUG = -g  #-DPRINT_TIME
INCLUDE = -I./out/include/ -I./three -I./utils -I.  -I./logApi/ -I./PlayBackAudio/ -I./AudioService -I./MicDataSource
LD_FLAG = -L./out/lib
...
OBJS = musicBoxMain.o threadFunc.o ./logApi/log.o MicDataSource/MicDataSource.o  \
	AudioService/AudioPreprocessDispatcher.o  AudioService/IWakeupService.o \
	AudioService/WakeupEvent.o AudioService/LedService.o ./AudioService/TtsService.o ./AudioService/AsrService.o ./AudioService/SemanticsAnalysis.o  ./AudioService/NeteaseMusicService.o ./AudioService/DownloadService.o ./AudioService/NeteaseMusicLanucher.o \
	api/BaiduVoice.o api/TokenHolder.o api/TtsResult.o api/TwirlingVad.o api/Ali_RestfulASR.o   \
	utils/util.o utils/fifo.o utils/serialControl.o AudioService/DeviceInfo.o ./PlayBackAudio/PlayBackAudio.o
DEP_DIR = ./MicDataSource ./AudioService ./api ./utils ./logApi ./PlayBackAudio
