...
*/
void micArraySetBeamforming(void *obj, int mode, float maxSupDB, float targetDirection, float targetEstimation, float nlpSup, float mainlobeWidth);
...
*/
void beamformingSet(void *obj, int mode, float maxSupDB, float targetDirection, float targetEstimation, float nlpSup, float mainlobeWidth);
